 ...
 * efficiency 接口（无权限控制）：currentIntelligentList 含 groupKey、regionName、npuUseRate、sellableAmount、allocationRate
        ...
        resolve({
          ...
          data: {
            ...
            currentIntelligentList: [
              { groupKey: "华东-上海二(AZ1)", regionName: "华东-上海二(AZ1)", npuUseRate: 0.72, sellableAmount: 600, allocationRate: 1, npuCardTimeUseRate: 0.68 },
              { groupKey: "华东-北京四(AZ1)", regionName: "华东-北京四(AZ1)", npuUseRate: 0.55, sellableAmount: 3600, allocationRate: 1, npuCardTimeUseRate: 0.51 },
              { groupKey: "华北-北京一(AZ1)-c6-mgr-2", regionName: "华北-北京一(AZ1)-c6-mgr-2", npuUseRate: 0.43, sellableAmount: 250, allocationRate: 0.9788, npuCardTimeUseRate: 0.39 },
              { groupKey: "华东-上海一(AZ2)-c6-mgr-1", regionName: "华东-上海一(AZ2)-c6-mgr-1", npuUseRate: 0.88, sellableAmount: 80, allocationRate: 1, npuCardTimeUseRate: 0.82 },
              { groupKey: "华南-深圳一(AZ1)-c6-mgr-3", regionName: "华南-深圳一(AZ1)-c6-mgr-3", npuUseRate: 0.31, sellableAmount: 120, allocationRate: 0.9910, npuCardTimeUseRate: 0.27 },
              { groupKey: "华北-北京一(AZ2)-c6-mgr-1", regionName: "华北-北京一(AZ2)-c6-mgr-1", npuUseRate: 0.65, sellableAmount: 4200, allocationRate: 1, npuCardTimeUseRate: 0.60 },
            ],
          },
        }),
      200
...
function toChartData(mergedList) {
  const toNum = (v) => (v != null ? Number(v) || 0 : null);
